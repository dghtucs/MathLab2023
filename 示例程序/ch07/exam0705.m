...
[x4,v4,exit4,out4]=fminunc(@exam0705fun,x0,fopt)
pause
'---case5: bfgs, 3rd poly-------'
...
[x6,v6,exit6,out6]=fminunc(@exam0705fun,x0,fopt)
pause
'---case7: gillmurray, 3rd poly-------'
%fopt=optimset(opt2,'HessUpdate','gillmurray');
%[x7,v7,exit7,out7]=fminunc(@exam0705fun,x0,fopt)
%pause
...
solutions=[x1;x2;x4;x5;x6;x8];
funvalues=[v1;v2;v4;v5;v6;v8];
iterations=[out1.funcCount;out2.funcCount;out4.funcCount;out5.funcCount;out6.funcCount;out8.funcCount];
